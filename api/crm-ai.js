...
const CATALOG_HINT = `Ориентиры цен (₸, можно корректировать под объём):
Лендинг 50000; Корпоративный сайт 150000; Интернет-магазин 250000; Веб-платформа/SaaS 500000;
Мобильное приложение 300000; Бизнес-автоматизация процессов 200000; Внедрение CRM Fibonacci Control 150000;
Настройка/поддержка CRM в мес 50000; Интеграция WhatsApp/Instagram/API 60000; AI-контент/монтаж 80000;
Съёмка+монтаж 120000; SMM в мес 100000; IT-поддержка в мес 50000.`;

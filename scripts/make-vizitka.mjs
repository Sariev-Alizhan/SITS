...
const I18N = {
  ru: {
    ...
    svc: [
      ...
      ['AI Content Creator','от 100 000 ₸','Реклама, клипы и контент, созданные AI: сценарий, генерация, постпродакшн, звук, дистрибуция.'],
      ['AI Love Story','от 50 000 ₸','Персональная видео-история о вашей паре, созданная AI из фотографий и воспоминаний. Подарок на свадьбу или годовщину.'],
      ['Техподдержка сайтов','от 10 000 ₸/мес','Правки каждую неделю, мониторинг и обновления — сайт всегда живой и актуальный.'],
  ...
  en: {
    ...
    svc: [
      ...
      ['AI Content Creator','from 100 000 ₸','AI-made ads, clips and content: script, generation, post-production, sound, distribution.'],
      ['AI Love Story','from 50 000 ₸','A personal AI-made video story about your couple, built from photos and memories. A gift for a wedding or anniversary.'],
      ['Website support','from 10 000 ₸/mo','Weekly edits, monitoring and updates — your site stays alive and current.'],
  ...
  kk: {
    ...
    svc: [
      ...
      ['AI Content Creator','100 000 ₸-ден','AI жасаған жарнама, клиптер мен контент: сценарий, генерация, постпродакшн, дыбыс, дистрибуция.'],
      ['AI Love Story','50 000 ₸-ден','Жұбыңыз туралы AI жасаған жеке видео-хикая — фотолар мен естеліктерден. Тойға немесе мерейтойға сыйлық.'],
      ['Сайттарды техқолдау','айына 10 000 ₸-ден','Апта сайын түзетулер, мониторинг және жаңартулар — сайт әрқашан тірі.'],

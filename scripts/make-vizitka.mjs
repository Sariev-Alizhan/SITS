...
const I18N = {
  ru: {
    ...
    secTag: 'Услуги и цены · −80% до 1 сентября',
    svc: [
      ['Сайты и лендинги','от 30 000 ₸','Продающие сайты под ключ: дизайн, адаптив, SEO, запуск за 3–7 дней. Вариант с AI-автоответчиком 24/7.'],
      ['Мобильные приложения','от 400 000 ₸','iOS и Android под ключ: дизайн, бэкенд, публикация в App Store и Google Play.'],
      ['Разработка игр','от 40 000 ₸','Unity и Unreal: от веб-игр до крупных проектов на мобильные, ПК и PlayStation. Самый крупный кейс — игра за $10 млн.'],
      ['AI Video Creator','от 100 000 ₸','Реклама и видеоклипы с AI любой сложности: сценарий, генерация, монтаж, звук, помощь с дистрибуцией.'],
      ['Медиа-продакшн','от 900 ₸','Проф съёмка по Астане, монтаж часовых роликов, нарезки под Reels и TikTok. Кейс: подкаст Damn Disn × Maunfeld.'],
      ['SMM и таргет','от 30 000 ₸','Ведение TikTok и Instagram под ключ с мобилографом, контентом и аналитикой каждый месяц.'],
      ['Автоматизация бизнеса','от 200 000 ₸','Полная цифровизация под ключ: CRM, AI-агенты на Claude, интеграции с WhatsApp, Kaspi, 1C.'],
      ['Интеграции и команда','от 400 000 ₸/год','Международные партнёрства для бизнеса и подбор сильных специалистов в медиа, IT и AI — фокус на Казахстан и СНГ.'],
    ],
  ...
  en: {
    ...
    secTag: 'Services & prices · −80% until Sep 1',
    svc: [
      ['Websites & landing pages','from 30 000 ₸','Turnkey selling websites: design, responsive, SEO, launch in 3–7 days. Option with a 24/7 AI auto-responder.'],
      ['Mobile apps','from 400 000 ₸','Turnkey iOS and Android: design, backend, App Store and Google Play release.'],
      ['Game development','from 40 000 ₸','Unity and Unreal: from web games to large projects for mobile, PC and PlayStation. Our largest case — a $10M game.'],
      ['AI Video Creator','from 100 000 ₸','AI ads and music videos of any complexity: script, generation, editing, sound, distribution help.'],
      ['Media production','from 900 ₸','Pro shoots in Astana, hour-long video editing, cuts for Reels and TikTok. Case: the Damn Disn podcast × Maunfeld.'],
      ['SMM & targeted ads','from 30 000 ₸','End-to-end TikTok and Instagram management with a mobile videographer, content and monthly analytics.'],
      ['Business automation','from 200 000 ₸','Turnkey digitalization: CRM, Claude-powered AI agents, WhatsApp, Kaspi and 1C integrations.'],
      ['Integrations & talent','from 400 000 ₸/yr','International partnerships for business and recruiting of strong media, IT & AI specialists — focus on Kazakhstan and the CIS.'],
    ],
  ...
  kk: {
    ...
    secTag: 'Қызметтер мен бағалар · 1 қыркүйекке дейін −80%',
    svc: [
      ['Сайттар мен лендингтер','30 000 ₸-ден','Дайын сатушы сайттар: дизайн, адаптив, SEO, 3–7 күнде іске қосу. 24/7 AI-автожауапбергіш нұсқасы бар.'],
      ['Мобильді қосымшалар','400 000 ₸-ден','iOS және Android толық дайын: дизайн, бэкенд, App Store мен Google Play-ге жариялау.'],
      ['Ойын жасау','40 000 ₸-ден','Unity және Unreal: веб-ойындардан мобильді, ПК және PlayStation ірі жобаларына дейін. Ең ірі кейс — $10 млн ойын.'],
      ['AI Video Creator','100 000 ₸-ден','Кез келген күрделіліктегі AI жарнамалар мен клиптер: сценарий, генерация, монтаж, дыбыс, дистрибуцияға көмек.'],
      ['Медиа-продакшн','900 ₸-ден','Астанада кәсіби түсірілім, сағаттық роликтер монтажы, Reels пен TikTok-қа нарезкалар. Кейс: Damn Disn × Maunfeld подкасты.'],
      ['SMM және таргет','30 000 ₸-ден','TikTok пен Instagram-ды толық жүргізу: мобилограф, контент және ай сайынғы аналитика.'],
      ['Бизнесті автоматтандыру','200 000 ₸-ден','Толық цифрландыру: CRM, Claude негізіндегі AI-агенттер, WhatsApp, Kaspi, 1C интеграциялары.'],
      ['Интеграциялар және команда','жылына 400 000 ₸-ден','Бизнеске халықаралық серіктестік және медиа, IT & AI мықты мамандарын іріктеу — Қазақстан мен ТМД-ға назар.'],
    ],

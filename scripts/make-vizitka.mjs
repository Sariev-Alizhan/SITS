...
const I18N = {
  ru: {
    ...
    svc: [
      ['Сайты и лендинги','от 150 000 ₸','Продающие сайты под ключ: дизайн, адаптив, SEO, запуск за 3–7 дней. Вариант с AI-автоответчиком 24/7.'],
      ['Мобильные приложения','от 2 000 000 ₸','iOS и Android под ключ: дизайн, бэкенд, публикация в App Store и Google Play.'],
      ['Разработка игр','от 200 000 ₸','Unity и Unreal: от веб-игр до крупных проектов на мобильные, ПК и PlayStation. Самый крупный кейс — игра за $10 млн.'],
      ['AI Content Creator','от 500 000 ₸','Реклама, клипы и контент, созданные AI: сценарий, генерация, постпродакшн, звук, дистрибуция.'],
      ['AI Love Story','от 250 000 ₸','Персональная видео-история о вашей паре, созданная AI из фотографий и воспоминаний. Подарок на свадьбу или годовщину.'],
      ['Техподдержка сайтов','от 50 000 ₸/мес','Правки каждую неделю, мониторинг и обновления — сайт всегда живой и актуальный.'],
      ['Автоматизация бизнеса','от 1 000 000 ₸','Полная цифровизация под ключ: CRM, AI-агенты на Claude, интеграции с WhatsApp, Kaspi, 1C.'],
      ['Интеграции и команда','от 2 000 000 ₸/год','Международные партнёрства для бизнеса и подбор сильных специалистов в медиа, IT и AI — фокус на Казахстан и СНГ.'],
    ],
  ...
  en: {
    ...
    svc: [
      ['Websites & landing pages','from 150 000 ₸','Turnkey selling websites: design, responsive, SEO, launch in 3–7 days. Option with a 24/7 AI auto-responder.'],
      ['Mobile apps','from 2 000 000 ₸','Turnkey iOS and Android: design, backend, App Store and Google Play release.'],
      ['Game development','from 200 000 ₸','Unity and Unreal: from web games to large projects for mobile, PC and PlayStation. Our largest case — a $10M game.'],
      ['AI Content Creator','from 500 000 ₸','AI-made ads, clips and content: script, generation, post-production, sound, distribution.'],
      ['AI Love Story','from 250 000 ₸','A personal AI-made video story about your couple, built from photos and memories. A gift for a wedding or anniversary.'],
      ['Website support','from 50 000 ₸/mo','Weekly edits, monitoring and updates — your site stays alive and current.'],
      ['Business automation','from 1 000 000 ₸','Turnkey digitalization: CRM, Claude-powered AI agents, WhatsApp, Kaspi and 1C integrations.'],
      ['Integrations & talent','from 2 000 000 ₸/yr','International partnerships for business and recruiting of strong media, IT & AI specialists — focus on Kazakhstan and the CIS.'],
    ],
  ...
  kk: {
    ...
    svc: [
      ['Сайттар мен лендингтер','150 000 ₸-ден','Дайын сатушы сайттар: дизайн, адаптив, SEO, 3–7 күнде іске қосу. 24/7 AI-автожауапбергіш нұсқасы бар.'],
      ['Мобильді қосымшалар','2 000 000 ₸-ден','iOS және Android толық дайын: дизайн, бэкенд, App Store мен Google Play-ге жариялау.'],
      ['Ойын жасау','200 000 ₸-ден','Unity және Unreal: веб-ойындардан мобильді, ПК және PlayStation ірі жобаларына дейін. Ең ірі кейс — $10 млн ойын.'],
      ['AI Content Creator','500 000 ₸-ден','AI жасаған жарнама, клиптер мен контент: сценарий, генерация, постпродакшн, дыбыс, дистрибуция.'],
      ['AI Love Story','250 000 ₸-ден','Жұбыңыз туралы AI жасаған жеке видео-хикая — фотолар мен естеліктерден. Тойға немесе мерейтойға сыйлық.'],
      ['Сайттарды техқолдау','айына 50 000 ₸-ден','Апта сайын түзетулер, мониторинг және жаңартулар — сайт әрқашан тірі.'],
      ['Бизнесті автоматтандыру','1 000 000 ₸-ден','Толық цифрландыру: CRM, Claude негізіндегі AI-агенттер, WhatsApp, Kaspi, 1C интеграциялары.'],
      ['Интеграциялар және команда','жылына 2 000 000 ₸-ден','Бизнеске халықаралық серіктестік және медиа, IT & AI мықты мамандарын іріктеу — Қазақстан мен ТМД-ға назар.'],
    ],
